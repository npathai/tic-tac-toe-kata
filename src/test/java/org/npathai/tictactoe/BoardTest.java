...
class BoardTest {
    ...
    @ParameterizedTest
    @MethodSource
    public void returnsTrueWhenAnyDiagonalIsSelectedWithPlayersMarks(List<Mark> marks, PlayerMark checkChar) {
    ...
    @ParameterizedTest
    @MethodSource
    public void returnsFalseWhenAnyDiagonalIsNotSelectedWithPlayersMarks(List<Mark> marks, PlayerMark checkChar) {
        marks.forEach(mark -> board.update(mark.cellNo, mark.playerMark));
    ...
    static class Mark {
        ...
        public Mark(int cellNo, PlayerMark playerMark) {
            this.cellNo = cellNo;
